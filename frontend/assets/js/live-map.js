...
function hubPopupHTML(route) {
  ...
  return `<div style="font-family:Montserrat,sans-serif;min-width:180px;">
    ...
    <a href="index.html?from=${route.hub}" style="display:block;margin-top:10px;background:${hubColor};color:#ffffff;text-align:center;padding:6px;border-radius:6px;font-size:0.7rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;text-decoration:none;">Book from ${hubName}</a>
  </div>`;
}
...
function destPopupHTML(route) {
  return `<div style="font-family:Montserrat,sans-serif;min-width:160px;">
    ...
    <a href="index.html?to=${route.to}" style="display:block;margin-top:10px;background:#cc1f36;color:#ffffff;text-align:center;padding:6px;border-radius:6px;font-size:0.7rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;text-decoration:none;">Book to ${route.toCity}</a>
  </div>`;
}
...
function airportPopupHTML(icao, city, iata) {
  return `<div style="font-family:Montserrat,sans-serif;min-width:160px;">
    ...
    <a href="index.html?to=${icao}" style="display:block;margin-top:10px;background:#cc1f36;color:#ffffff;text-align:center;padding:6px;border-radius:6px;font-size:0.7rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;text-decoration:none;">Book to ${city}</a>
  </div>`;
}
